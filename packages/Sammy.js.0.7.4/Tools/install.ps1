...
try {
    $vsDocProjectItem = $scriptsFolderProjectItem.ProjectItems.Item("sammy-$ver-vsdoc.js")
...
AddOrUpdate-Reference $scriptsFolderProjectItem $sammyFileNameRegEx $sammyFileName